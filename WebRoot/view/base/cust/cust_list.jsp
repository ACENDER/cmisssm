...
<head>
    ...
    <script type="text/javascript">
        ...
        //首页
        function firstPage() {
            document.forms[0].action = "${pageContext.request.contextPath}/cust/getCustListByPage?pageNo=1&pageSize=10";
...
<form action="clientinfo/openList_clientInfo" method="post">
    ...
    <div class="rightinfo">
        <div class="tools">
            <ul class="toolbar1">
                <li><a href="clientInfoAdd.html"><span><img src="${pageContext.request.contextPath}/image/t01.png"/></span>添加</a></li>
                <li><a href="clientInfoUpdate.html"><span><img src="${pageContext.request.contextPath}/image/t02.png"/></span>修改</a></li>
                <li><a href="javascript:confirmMsgDel()"><span><img src="${pageContext.request.contextPath}/image/t03.png"/></span>删除</a></li>
            </ul>
        </div>
